...
type InterchainEventPacket struct {
	...
	Event string `protobuf:"bytes,1,opt,name=event,proto3" json:"event,omitempty"`
	// attributes defines additional optional event attributes.
...
func (m *InterchainEventPacket) GetEvent() string {
	if m != nil {
		return m.Event
	}
	return ""
...
func (m *InterchainEventPacket) GetAttributes() []byte {
	if m != nil {
		return m.Attributes
	}
	return nil
...
var fileDescriptor_094017127cbec1c8 = []byte{
	...
	,
}
...
func (m *InterchainEventPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Attributes) > 0 {
		...
		i = encodeVarintPacket(dAtA, i, uint64(len(m.Attributes)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Event) > 0 {
